...
<body class="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <div class="login-layout">
        <div class="login-card">
            ...
            @if($errors->any())
                <div class="panel"
                    style="background-color: var(--danger-light); border-color: var(--danger-color); color: var(--danger-color); padding: 12px; margin-bottom: 20px; border-radius: var(--btn-radius); text-align: start; font-size: 0.85rem;">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group" style="text-align: start;">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="admin@Dokkan.com" required
                        value="{{ old('email') }}">
                </div>
                ...
                <div class="form-group"
                    ...
                    <label
                        style="display: flex; align-items: center; gap: 8px; font-size: 0.85rem; color: var(--text-secondary); cursor: pointer; user-select: none;">
                ...
                <button type="submit" class="btn btn-primary"
                    style="width: 100%; padding: 14px; font-size: 1rem; border-radius: var(--btn-radius);">
                    {{ __('messages.login') }}
                </button>
            </form>
        </div>
